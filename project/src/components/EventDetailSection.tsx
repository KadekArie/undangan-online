...
export default function EventDetailSection() {
  return (
    ...
    >
      <div className="px-4 md:px-16 lg:px-24 xl:px-64 py-18 pt-32 xl:py-24 bg-linear-to-b from-shadow-50 from-5% via-shadow-100/80 to-shadow-50 to-95% flex flex-col gap-8">
